...
import com.google.protos.grpc.testing.Services.BenchmarkServiceGrpc.BenchmarkServiceImplBase;
...
public class MockBenchmarkServiceImpl extends BenchmarkServiceImplBase {
  private ArrayList<GeneratedMessageV3> requests;
  private Queue<Object> responses;

  public MockBenchmarkServiceImpl() {
  ...
  public void unaryCall(SimpleRequest request,
    ...
    if (response instanceof SimpleResponse) {
      ...
      responseObserver.onNext((SimpleResponse) response);
  ...
  public StreamObserver<SimpleRequest> streamingCall(
    ...
    StreamObserver<SimpleRequest> requestObserver =
        new StreamObserver<SimpleRequest>() {
      @Override
